...
class Your_Opt(NatureOpt):
    ...
    def __call__(self):
        ...
        z1 = self.InitOpt_Delta_z.your[0](t=t, old_z=self.z_0, w=self.w1)

        # Optimizing
        while not self.stop:
            new_Y = self.Opt_Delta_Y.your(old_y=Y, w=self.w2)
            temp_X = self.Opt_X.your(old_x=X, y=new_Y, x_g=X_g, z1=z1, w=self.w3)
            ...
            t = t + 1
            z = self.InitOpt_Delta_z.your[0](t=t, old_z=z, w=self.w1)
